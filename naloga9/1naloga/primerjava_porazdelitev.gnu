...
set title '$N_0=25$'
plot filename1 every ::1:1::1 u ($2):($1/10000) lc 4 lw 2 smooth freq w boxes title '$\beta =1$',\
filename2  every ::1:1::1 u ($2):($1/10000) lc 6 lw 2 smooth freq w boxes title\
'$\beta_s =5 \beta, \, \beta_r=4\beta$'
