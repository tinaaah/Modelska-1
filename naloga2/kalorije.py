...
tab = np.loadtxt('zelenjava.dat', usecols=range(1,10))
L=len(tab)
B = np.array([(0,2)]*L, dtype=float)
kcal, fat, CO, meat, Ca, Fe, C, K, Na_min, Na_max, kg = [],[],[],[],[],[],[],[],[],[],[]
for i in range(len(tab)): 
    ...
    kg.append(1)
c = kcal
A = [kg, fat, CO, meat, Ca, Fe, C, K, Na_min, Na_max]
b = [20., -70.0, -310.0, -50.0, -1.0, -0.018, -0.06, -3.5, -0.5, 2.4]
...
#print("Tako pojemo %.0fg hrane od tega %.2fg maščob, %.2fg ogljikovih hidratov, %.2fg proteinov, %.2fg kalcija, %.2fg železa, %.2fg vitamina C, %.2fg kalija in %.2fg natrija." % (kol, -temp1, -temp2, -temp3, -temp4, -temp5, -temp6, -temp7, -temp8))
