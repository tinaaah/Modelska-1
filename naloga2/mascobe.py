...
tab = np.loadtxt('tabela-zivil.dat', usecols=range(1,10))
L=len(tab)
...
#print("Tako pojemo %.0fg hrane od tega %.2fkcal, %.2fg ogljikovih hidratov, %.2fg proteinov, %.2fg kalcija, %.2fg železa, %.2fg vitamina C, %.2fg kalija in %.2fg natrija." % (kol, -temp1, -temp2, -temp3, -temp4, -temp5, -temp6, -temp7, -temp8))
