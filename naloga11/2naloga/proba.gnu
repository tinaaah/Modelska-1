...
filename3 = 'hitrosti.txt'

set xlabel '$t$'
#plot filename3 using 1:4 w lines lw 2 lc 6,\
#filename2 using 1:4 w lines lw 2 lc 4

plot filename2 using 1:2 w lines lw 2 lc 6,\
#filename2 using 1:5 w lines lw 2 lc 4
