...
\huge 10. naloga - Metropolisov algoritem\\ % The assignment title
...
\begin{figure}    
	...
	\centering 
	\resizebox{0.75\linewidth}{!}{\input{graf3.tex}} 
    \end{minipage}

    \begin{minipage}{\linewidth} 
	\centering
	\resizebox{0.75\linewidth}{!}{\input{graf4.tex}} 
    \end{minipage}

    \begin{minipage}{\linewidth} 
	\centering
	\resizebox{0.75\linewidth}{!}{\input{graf5.tex}} 
    \end{minipage}
...
\begin{figure}    
	...
	\centering 
	\resizebox{\linewidth}{!}{\input{graf6.tex}} 
    \end{minipage}
    \begin{minipage}{0.6\linewidth}
	\centering 
	\resizebox{\linewidth}{!}{\input{graf7.tex}} 
    \end{minipage}
...
\begin{figure}    
	...
	\resizebox{\textwidth}{!}{\input{graf9.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf12.tex}} 
    \end{subfigure}
    
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf13.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf14.tex}} 
    \end{subfigure}
    
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf15.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf16.tex}} 
    \end{subfigure}
...
\begin{figure}    
    \centering 
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf17.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf18.tex}} 
    \end{subfigure}
    
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf19.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf20.tex}} 
    \end{subfigure}
    
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf21.tex}} 
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
	\resizebox{\textwidth}{!}{\input{graf22.tex}} 
    \end{subfigure}
