...
# plot filename1 every :::0::0 u 0:1 w l ls 1 lc 'grey' title 'podatki',\
# filename1 every :::1::1 u 0:2 w l ls 2 title "napoved $p=10$"

# plot filename1 every :::0::0 u 0:1 w l ls 1 lc 'grey' title 'podatki',\
# filename1 every :::2::2 u 0:2 w l ls 5 title "napoved $p=15$"

# plot filename1 every :::0::0 u 0:1 w l ls 1 lc 'grey' title 'podatki',\
# filename1 every :::3::3 u 0:2 w l ls 6 title "napoved $p=20$"

plot filename1 every :::0::0 u 0:1 w l ls 1 lc 'grey' title 'podatki',\
filename1 every :::4::4 u 0:2 w l ls 6 title "napoved $p=25$"
