...
plot filename u 1:2 w lp ls 1 notitle 
...
# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::1::1 u 1:3 w l ls 3 title '$p=20$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::2::2 u 1:3 w l ls 3 title '$p=30$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::3::3 u 1:3 w l ls 3 title '$p=40$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::0::0 u 1:3 w l ls 4 title '$p=10$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::1::1 u 1:3 w l ls 4 title '$p=20$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::2::2 u 1:3 w l ls 4 title '$p=30$'

# plot filename u 1:2 w l lc 'grey' title 'podatki',\
# filename every :::3::3 u 1:3 w l ls 4 title '$p=40$'
